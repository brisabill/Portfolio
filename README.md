# Brisa Letieres – Data Science & Epidemiology Portfolio

Welcome!  
I am a **MSc in Vaccinology** with experience in **epidemiology, viral surveillance, data analysis, geospatial visualization, and interactive dashboards using R/Shiny**.  
This portfolio highlights my main projects, including dashboards, statistical analyses, machine learning visualizations, and public health data pipelines.

---

## 🧬 Shiny Applications

### **1. HPV Vaccination Dashboard (Brazil, 2020–2026)**
🔗 https://brisabill.shinyapps.io/hpv_app/
...
### **HPV Vaccination Coverage Maps (2020–2025)**
...
### **HPV Dose Schedule Trends (2020–2026)**
...
### **Embedding Projector (PCA / t-SNE / UMAP)**
Exploration of high-dimensional embeddings with:
- PCA 3D  
- t-SNE clustering  
